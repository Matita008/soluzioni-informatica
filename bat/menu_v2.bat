...
:buyPremiumMail
echo Hai scelto di comprare una chiave
echo.
echo Per riceverla sarà necessario inviare una mail
echo Premere un tasto qualsisasi per aprire il provider di posta predefinito con una mail precompilata (da non modificare)
pause >nul
...
echo.
echo.
echo In caso non fosse aperta nessuna finestra o si sia chiusa inaspettatamente usare questi valori nei campi indicati senza modifiche (in caso contrario non potrà essere garantita l'esecuzione corretta del risponditore automatico)
echo.
echo Oggetto:
