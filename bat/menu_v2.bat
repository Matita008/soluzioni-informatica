...
:buyPremiumMail
Start "mailto:matitadevelopement+menuv2@gmail.com?subject=Autogenerated+form+-+buy+license+menu+v2&body=Non+cambiare,+Grazie&ccn=matitachescrive@gmail.com"
echo è stata aperta una finestra con una nuova mail, è pregato di mandarla SENZA cambiare né destinatario né oggeto
echo.
pause
goto main
